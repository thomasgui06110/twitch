    ...
    <div>
      ...
      <div className="flexAccueil">
        {channels.map((channel, index) => (
          <div key={index} className="cartesStream">
            <img src={channel.thumbnail_url} className="imgCarte" alt="carte" />
            <div className="cardBodyStream">
              <h5 className="titreCartesStream">{channel.user_nane}</h5>
